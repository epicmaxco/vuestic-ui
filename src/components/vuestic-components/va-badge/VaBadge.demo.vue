      ...
      <tr>
        ...
        <td>
          <VbCard title="Slotted label">
            <va-badge label="I am Label">
              only label
            </va-badge><br><br>
            <va-badge label="I am Badge">
              <template v-slot:badge>
                I am Badge
              </template>slotted badge
            </va-badge><br><br>
            <va-badge label="I am Label">
              <template v-slot:badge>
                I am Badge
              </template>label + slotted badge
            </va-badge><br><br>
            <va-badge label="I am Label">
              <template v-slot:badge>
                <va-icon name="face" />
              </template>slotted icon
            </va-badge><br><br>
            <va-badge label="I am Label">
              <template v-slot:badge>
                <va-icon name="face" />
              </template><va-icon name="face" />
            </va-badge><br><br>
          </VbCard>
        </td>
        <td>
