...
export default [
  ...
  DocsHelper.paragraph('overview.configurations.title'),
  // DocsHelper.paragraph('overview.configurations.localConfig'),
  // DocsHelper.paragraph('overview.configurations.globalConfig'),
