...
export default definePageConfig({
  blocks: [
    ...
    block.subtitle("grid.examples.default.title"),
    block.example("Default"),

    block.subtitle("grid.examples.breakpoints.title"),
    ...
    block.subtitle("grid.examples.offsets.title"),
    ...
    block.subtitle("grid.examples.gutters.title"),
    ...
    block.subtitle("grid.api.align.title"),
    ...
    block.subtitle("grid.api.alignSelf.title"),
    ...
    block.subtitle("grid.api.alignContent.title"),
    ...
    block.subtitle("grid.api.justify.title"),
    ...
    block.subtitle("grid.api.justifySelf.title"),
