...
export default definePageConfig({
  blocks: [
    ...
    block.subtitle("appBar.examples.default.title"),
    block.paragraph("appBar.examples.default.text"),
    block.example("Default"),
    block.subtitle("appBar.examples.color.title"),
    block.paragraph("appBar.examples.color.text"),
    block.example("Color"),
    block.subtitle("appBar.examples.bottom.title"),
    block.paragraph("appBar.examples.bottom.text"),
    block.example("Bottom"),
    block.subtitle("appBar.examples.hide.title"),
    block.paragraph("appBar.examples.hide.text"),
    block.example("Hide"),
    block.subtitle("appBar.examples.shadow.title"),
