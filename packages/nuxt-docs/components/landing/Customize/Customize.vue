...
import Prism from '../PrismWrapper.vue'
...
const bgGradientStyle = computed(() => ({
  background: `linear-gradient(180.81deg, ${shiftHSLAColor(colors.value.primary, {
    s: -15,
    l: -20,
  })} 0.7%, ${shiftHSLAColor(colors.value.primary, {
    h: 10,
    s: -5,
    l: -10,
  })} 99.3%)`,
...
const btnClick = () => { clicksCount.value++ }

const codeInput = ref(null)
const message = ref(null)

const copyText = () => {
  const testingCodeToCopy = codeInput.value
