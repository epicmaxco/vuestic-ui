<template>
  <ElementLayout>
    <template #element>
      <VaSelect v-bind="props" :model-value="value" @update:model-value="handleInput" v-on="listeners" ref="input" :error="isError">
...
export default defineVuesticElement({ name: 'VaSelectElement', components: [VaSelect], emits: VaSelect.emits, props, propsToOmit })
</script>
