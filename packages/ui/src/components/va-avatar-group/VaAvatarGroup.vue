...
const VaAvatarPropsDeclaration = extractComponentProps(VaAvatar)
</script>
...
const filteredAvatarProps = filterComponentProps(VaAvatarPropsDeclaration)
