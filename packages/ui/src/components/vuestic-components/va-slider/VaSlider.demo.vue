<template>
  <VbDemo>
    ...
    <VbCard
      width="500px"
      title="Slider With Inverted Slot Label"
    >
      <va-slider
        label="Label"
        invert-label
    ...
    <VbCard
      width="500px"
      title="Range With Visible Value"
    >
      <va-slider
        range
        track-label-visible
