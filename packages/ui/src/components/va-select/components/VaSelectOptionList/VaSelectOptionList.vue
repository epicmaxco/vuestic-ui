...
import { ref, shallowRef, watch, computed, PropType } from 'vue'
...
const optionGroupsThrottled = useThrottleValue(computed(() => filteredOptions.value
...
const optionGroups = optionGroupsThrottled
</script>
