...
watchEffect(() => {
  ...
  for (let i = 0; i < slides.length; i++) {
    ...
    if (i === modelValue.value) {
      slide.classList.remove('va-carousel-effect-none__slide--hidden')
    } else {
      slide.classList.add('va-carousel-effect-none__slide--hidden')
      slide.classList.add('va-carousel-effect-none__slide')
    }
  }
})
