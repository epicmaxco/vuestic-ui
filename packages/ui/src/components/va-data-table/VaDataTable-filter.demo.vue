  ...
  <VbDemo>
    <VbCard>
      <div class="row">
        <va-input
          v-model="input"
          className="flex flex-col mb-2 md6 xs12"
          placeholder="Filter..."
        />
...
export default defineComponent({
  ...
  data () {
    ...
    const columns = [
      { key: 'id', sortable: true, filterable: false },
      { key: 'username', sortable: true, filterable: false },
      { key: 'name', sortable: true, filterable: false },
      { key: 'email', sortable: true, filterable: true },
      { key: 'address.zipcode', label: 'Zipcode', filterable: false },
    ]
