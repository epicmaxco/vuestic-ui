...
const VaRatingItemPropsDeclaration = extractComponentProps(VaRatingItem, ['modelValue', 'itemNumber'])
const VaRatingItemNumberButtonPropsDeclaration = extractComponentProps(VaRatingItemNumberButton, ['modelValue', 'itemNumber'])
</script>

<script lang="ts" setup>
const props = defineProps({
  ...VaRatingItemNumberButtonPropsDeclaration,
  ...useRatingProps,
  ...useVaRatingColorsProps,
  ...useFormFieldProps,
  ...VaRatingItemPropsDeclaration,
...
const VaRatingItemProps = filterComponentProps(VaRatingItemPropsDeclaration)
const VaRatingItemNumberButtonProps = filterComponentProps(VaRatingItemNumberButtonPropsDeclaration)
