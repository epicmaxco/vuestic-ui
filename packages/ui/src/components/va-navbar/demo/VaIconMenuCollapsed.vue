<template>
  <svg
    ...
    viewBox="0 0 24 24"
  >
    <g v-if="collapsed" fill="none" fill-rule="nonzero">
      <path d="M0 0h24v24H0z"></path>
      <rect width="20" height="2" x="2" y="3" :fill="color" rx="1"></rect>
      <path
        :fill="color"
      ...
      ></path>
      <rect width="20" height="2" x="2" y="19" :fill="color" rx="1"></rect>
    </g>
    <g v-else fill="none" fill-rule="nonzero">
      <path d="M0 0h24v24H0z"></path>
      <rect width="20" height="2" x="2" y="3" :fill="color" rx="1"></rect>
      <path
        :fill="color"
      ...
      ></path>
      <rect width="20" height="2" x="2" y="19" :fill="color" rx="1"></rect>
      <path :stroke="color" stroke-width="2" d="M4 9l-3 3 3 3"></path>
    </g>
  </svg>
</template>
