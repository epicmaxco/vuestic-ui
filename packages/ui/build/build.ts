...
defineVuesticBuild(async () => {
  ...
  await Promise.all([
    ...
    $('vite build --config ./build/configs/vite.styles.ts', { successMessage: 'styles built' }),
    $('vite build --config ./build/configs/vite.styles-essential.ts', { successMessage: 'essential styles built' }),
  ])
