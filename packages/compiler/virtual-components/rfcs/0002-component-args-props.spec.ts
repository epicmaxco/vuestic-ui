...
describe('Virtual Components', () => {
  describe('Syntax', () => {
    ...
    describe('props', () => {
      ...
      describe('props calculation (string)', async () => {
        const button = await createVirtualComponent('VcButton', `
          <script setup lang="ts">
            defineProps({
              firstName: String,
      ...
      describe('props calculation (number)', async () => {
        const button = await createVirtualComponent('VcButton', `
          <script setup lang="ts">
            defineProps({
              price: Number,
      ...
      describe('props multiple calculation', async () => {
        const button = await createVirtualComponent('VcButton', `
          <script setup lang="ts">
            defineProps({
              price: Number,
      ...
      test('props calculation static+dynamic (bind)', async () => {
      ...
      describe('props with default value', () => {
        ...
        test('props default value', async () => {
          const button = await createVirtualComponent('VcButton', `
            <script setup lang="ts">
              defineProps({
