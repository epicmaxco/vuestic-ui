...
<script lang="ts">
//@ts-nocheck
import VaIconVuestic from "../../../../ui/src/components/vuestic-components/va-icon/va-iconset/VaIconVuestic.vue";
...
import VaNavbar from "../../../../ui/src/components/vuestic-components/va-navbar/VaNavbar.vue";
