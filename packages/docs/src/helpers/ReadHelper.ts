...
export class ReadHelper {
  public static async readTemplate (path: string, fileName: string): Promise<any> {
    return await import(
  ...
  public static async readComponent (path: string, fileName: string): Promise<any> {
    return await import(
      /* webpackChunkName: "examples" */
      /* webpackMode: "lazy-once" */
  ...
  public static async readDocsComponent (path: string, fileName: string): Promise<any> {
    return await import(
