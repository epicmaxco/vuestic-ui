...
export default definePageConfig({
  blocks: [
    ...
    block.paragraph("modal.examples.anchor.text"),
    block.example("Anchor", { hideTitle: true }),
    block.paragraph("modal.examples.customContent.text"),
    block.example("CustomContent", { hideTitle: true }),
